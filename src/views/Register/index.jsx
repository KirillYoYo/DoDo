      ...
      <Row className="register-row" type="flex" justify="space-around" align="middle">
        <Col span="8">
          <Form layout="horizontal" onSubmit={this.handleSubmit.bind(this)} className="register-form">
            ...
            <p>
              <Button className="btn-register" type='primary' size="large" icon="right-square-o" loading={this.state.loading} htmlType='submit'>Registration</Button>
            </p>
            <p>
              <Button className="btn-login" size="large" icon="poweroff" htmlType='button' onClick={this.toLogin.bind(this)}>To login</Button>
            </p>
          </Form>
        </Col>
      </Row>
